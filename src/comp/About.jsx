...
const About = () => {
  return (
    <div>
      ...
      <div className="p-4 md:flex md:w-[90%] m-auto mt-5 gap-2">
        <div className="w-[100%] md:w-[80%] lg:w-[50%]">
          <h1 className=" font-Inter font-bold text-[36px]">The Mission</h1>
        ...
        <div>
          <img src="/img-group.png" alt="" className=""/>
        </div>
      </div>
      <div className=" md:w-[90%] m-auto">
        <div className="mt-[100px] mb-[100px]">
          <h1 className="text-center text-[35px] font-Inter font-bold mt-9 mb-9">Why Choose Us?</h1>
        ...
        <div className="flex flex-wrap gap-10   font-Inter md:w-[80%] md:m-auto justify-between pt-[70px] pb-[70px]">
          <div>
